...
* **Dropout did not improve performance, so I started to hunt around for what might be happening. Christopher Bourez's blog let me do to [this paper](https://arxiv.org/abs/1507.01526) which I've reviewed here.**
